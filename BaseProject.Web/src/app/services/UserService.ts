...
export class UserService {
  ...
  FindAll(): Observable<any> {
    return this.http.get(this.appSettings.ApiUrl() + '/users', { withCredentials: true })
      .catch(this.handleError)
      .map(res => res.json());
  }
  FindById(id: number): Observable<any> {
    return this.http.get(this.appSettings.ApiUrl() + '/users/' + id, { withCredentials: true })
      .catch(this.handleError)
      .map(res => res.json());
  }
  ...
  Login(request: ILoginRequest): Observable<any> {
    ...
    return this.http.post(this.appSettings.ApiUrl() + '/users/login', params, { withCredentials: true, headers: headers })
      .catch(this.handleError)
      .map(res => res.json());
  }
  Logout(): Observable<any> {
    ...
    return this.http.post(this.appSettings.ApiUrl() + '/users/logout', null, { withCredentials: true, headers: headers })
      .catch(this.handleError)
      .map(res => res.json());
  }
  Register(request: IRegistrationRequest): Observable<any> {
    ...
    var params = JSON.stringify(request);
    return this.http.post(this.appSettings.ApiUrl() + '/users/register', params, { withCredentials: true, headers: headers })
      .catch(this.handleError)
      .map(res => res.json());
  }
  ...
  IsLoggedOn(): Observable<any> {
    var headers = this.serviceHelper.GetHeaders();
    return this.http.get(this.appSettings.ApiUrl() + '/users/isloggedon', { withCredentials: true, headers: headers })
      .catch(this.handleError)
      .map(res => res.json());
  }
