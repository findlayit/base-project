...
using LoginResult = BaseProject.BusinessProvider.Models.Users.LoginResult;
using RegistrationRequest = BaseProject.BusinessProvider.Models.Users.RegistrationRequest;
...
namespace BaseProject.BusinessProviders
{
    public class UserManager : IUserManager
    {
        ...
        {
            var entity = _mapper.Map<UserEntity>(item);
